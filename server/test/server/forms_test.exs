defmodule Server.FormsTest do
  ...
  describe "scba_forms" do
    ...
    test "create_scba_form/1 with valid data creates a scba_form" do
      valid_attrs = %{complete: true, name: "some name", date: ~N[2024-05-04 19:18:00], clean: true, unit_number: 42, lights_working: true, bottle_full: true, straps_extended: true, damage: true}
      ...
      assert scba_form.date == ~N[2024-05-04 19:18:00]
    ...
    test "update_scba_form/2 with valid data updates the scba_form" do
      scba_form = scba_form_fixture()
      update_attrs = %{complete: false, name: "some updated name", date: ~N[2024-05-05 19:18:00], clean: false, unit_number: 43, lights_working: false, bottle_full: false, straps_extended: false, damage: false}
      ...
      assert scba_form.date == ~N[2024-05-05 19:18:00]
